...
public class RSAEncodeDecodeTest {
	...
	*/
    ...
    public void testBadModulusSize(){
        new RSAKeyPair(new BigInteger("3233"), new BigInteger("17"), new BigInteger("2753"), 20);
    }
    
    @Test
    public void testKeyPair() {
        KeyPair keyPair = new RSAKeyPair(new BigInteger("3233"), new BigInteger("17"), new BigInteger("2753"), 16);
        ...
        keyPair = new RSAKeyPair(new BigInteger("17947"), new BigInteger("3"), new BigInteger("11787"), 16);
