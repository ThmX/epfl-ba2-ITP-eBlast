...
/**
 * This Exception is thrown when a Bloc has the wrong length.
 *
 ...
 */
public class BlockLengthException extends EBlastException {
	/**
	...
	/**
	 * Thrown when a Bloc has the wrong length.
	 * @param required Byte Length that should have been received.
	 * @param received Byte Length that has been received.
	 */
	public BlockLengthException(int required, int received) {
		super("Block length should be " + required + " bytes instead of " + received + ".");
	}
}
